...
(2, 'Evolene Evomass Gainer Coklat 912gr', 270000, 'pink', 'Bulking', 'Evolene Evomass Gainer merupakan susu penambah berat badan dan menambah massa otot dengan kandungan 52 gram protein, 932 kkal, 11 gram glutamine, dan 8,5 gram BCAA setiap 1 servings. Dengan kandungan protein yang tinggi, susu ini sangat cepat diserap pada tubuh agar massa otot cepat terbentuk. Evolene Evomass Gainer sudah bersertifikasi BPOM dan halal. Bagus Untuk Bulking', 'evomasswheycoklat.jpg'),
(7, 'L-Men Platinum Strawberry 800g', 400000, 'multi-color', 'Cutting', 'L-Men Platinum Susu Whey Protein merupakan suplemen protein yang cocok untuk melengkapi kegiatan olahraga terutama untuk latihan beban, gym, dan fitness. L-Men Platinum yang tinggi whey protein sebanyak 25 gram/saji, dan juga memiliki kandungan Asam Amino yang lebih tinggi dari kebanyakan susu Whey lainnya (5,7gr BCAA).', 'lmenstrawberry.jpg'),
(8, 'Love Story', 900, 'pink', 'Pre-Workout', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae augue sed turpis lobortis blandit. Cras sit amet risus nec felis commodo venenatis at eget nunc. Ut bibendum enim ut.', 'love_story1.jpg'),
