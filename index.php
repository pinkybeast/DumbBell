<?php
    ...
    if(isset($_POST['add_to_cart'])){
        ...
        if(mysqli_num_rows($sql_check_cart_num) > 0){
            ...
            mysqli_query($conn, "INSERT INTO cart(customer_id, pid, name, price, category, quantity, image) VALUES('$customer_id', '$product_id', '$product_name', '$product_price',  '$product_category', '', '$product_image')") or die('Query Failed');
